...
declare namespace core {
	...
	*/
	...
	@param sampleSize - SampleSize Sample size in bytes.
	...
	(async () => {
		...
		const stream = await fileType.stream(read.pipe(decipher), 1024);
	...
	```
	*/
	function stream(readableStream: ReadableStream, sampleSize?: number): Promise<core.ReadableStreamWithFileType>
}
