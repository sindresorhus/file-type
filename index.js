...
module.exports = input => {
	...
	if (
		(buf[0] === 0x7B && [0x20, 0x09, 0x0A, 0x0D, 0x22].includes(buf[1])) ||
		(buf[0] === 0x5B && [0x20, 0x09, 0x0A, 0x0D, 0x22, 0x2D, 0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39, 0x7B, 0x5B, 0x74, 0x66, 0x6e].includes(buf[1]))
	) {
		return {
			ext: 'json',
